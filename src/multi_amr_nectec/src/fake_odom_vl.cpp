...
int main(int argc, char** argv){
  ...
  while(nh.ok()){
    ...
    odom_trans.header.frame_id = "vl_robot/odom";
    odom_trans.child_frame_id = "vl_robot/base_link";
    ...
    odom.header.frame_id = "vl_robot/odom";
    ...
    //set the velocity
    odom.child_frame_id = "vl_robot/base_link";
