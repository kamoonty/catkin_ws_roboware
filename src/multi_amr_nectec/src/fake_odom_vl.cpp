...
int main(int argc, char** argv){
  ...
  while(n.ok()){
    ...
    odom_trans.transform.translation.x = get_vl.x;
    odom_trans.transform.translation.y = get_vl.y;
    ...
    //set the position
    odom.pose.pose.position.x = get_vl.x;
    odom.pose.pose.position.y = get_vl.y;
