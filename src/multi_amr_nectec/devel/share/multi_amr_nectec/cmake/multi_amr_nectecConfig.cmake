...
if("TRUE" STREQUAL "TRUE")
  set(multi_amr_nectec_SOURCE_PREFIX /home/kanin/roboware_nin/src/multi_amr_nectec)
  set(multi_amr_nectec_DEVEL_PREFIX /home/kanin/roboware_nin/devel)
  ...
  set(multi_amr_nectec_INSTALL_PREFIX /home/kanin/roboware_nin/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_amr_nectec' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kanin/roboware_nin/src/multi_amr_nectec/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kanin/roboware_nin/devel/lib;/home/kanin/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(multi_amr_nectec_EXPORTED_TARGETS "")
