...
{  get_vl.x=roundf(vl_pos.x*100)/100; // round to 5 decimal place
   get_vl.y=roundf(vl_pos.y*100)/100;
...
{ for (int i = 0; i<index; i++)
    { robot_pos[i].x=roundf((msg->point_robot[i].x)*100)/100; // round to 5 decimal place
      robot_pos[i].y=roundf((msg->point_robot[i].y)*100)/100;
